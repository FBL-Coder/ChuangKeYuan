...
public class BitmapCompressor {
     ...
     */
    public static String compressBitmap(String filepath, int maxkb, int reqWidth, int reqHeight) {
        try {
...
//          Log.i(test,压缩一次!);
                ...
                options_num -= 10;// 每次都减少10
                image.compress(Bitmap.CompressFormat.JPEG, options_num, baos);// 这里压缩options%，把压缩后的数据存放到baos中
            }
...
//        return bitmap;
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options,
        ...
        Log.i("BITMAP", "原尺寸: " + picwidth + "*" + picheight);
        ...
        if (targetheight > reqHeight || targetwidth > reqWidth) {
            while (targetheight >= reqHeight
                ...
                Log.i("BITMAP", "压缩: " + inSampleSize + "倍");
                inSampleSize += 1;
        ...
        Log.i("BITMAP", "最终压缩比例: " + inSampleSize + "倍");
        Log.i("BITMAP", "新尺寸:" + targetwidth + "*" + targetheight);
        return inSampleSize;
    }
}
