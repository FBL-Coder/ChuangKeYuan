...
import com.yitong.ChuangKeYuan.friendscircle.utils.DensityUtil;
...
//		this.setWidth(DensityUtil.dip2px(context,150));
		this.setWidth((int) context.getResources().getDimension(R.dimen.dp_220));
		this.setHeight((int) context.getResources().getDimension(R.dimen.dp_50));
