...
import com.yitong.ChuangKeYuan.friendscircle.widgets.videolist.VideoListGlideModule;
import com.yitong.ChuangKeYuan.friendscircle.widgets.videolist.model.VideoLoadMvpView;
import com.yitong.ChuangKeYuan.friendscircle.widgets.videolist.target.VideoLoadTarget;
import com.yitong.ChuangKeYuan.friendscircle.widgets.videolist.target.VideoProgressTarget;
        ...
        videoButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(videoUrl)){
                    ToastUtil.showToast(getContext(), "对不起，视频已损坏，无法播放...");
                    return;
                }
                // load video file
