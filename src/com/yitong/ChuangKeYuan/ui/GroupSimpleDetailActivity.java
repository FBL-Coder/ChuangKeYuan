				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							ToastUtil.showToast(GroupSimpleDetailActivity.this, st1+e.getMessage());
						}
					});
				}
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							pd.dismiss();
							if(group.isMembersOnly())
								ToastUtil.showToast(GroupSimpleDetailActivity.this, st3);
							else
								ToastUtil.showToast(GroupSimpleDetailActivity.this, st4);
					...
					runOnUiThread(new Runnable() {
						public void run() {
							pd.dismiss();
							ToastUtil.showToast(GroupSimpleDetailActivity.this, st5+e.getMessage());
						}
					});
				}
			}
