							...
							try {
								...
								runOnUiThread(new Runnable() {
									public void run() {
										...
										ToastUtil.showToast(getApplicationContext(), st6);
									}
								});
								...
								runOnUiThread(new Runnable() {
									public void run() {
										progressDialog.dismiss();
										ToastUtil.showToast(getApplicationContext(), st7);
									}
								});
							}
						}
			...
			public void run() {
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							progressDialog.dismiss();
							ToastUtil.showToast(getApplicationContext(), st6 + e.getMessage());
						}
					});
				}
			}
		        ...
		        public void run() {
		            try {
		                ...
		                runOnUiThread(new Runnable() {
		                    public void run() {
		                        progressDialog.dismiss();
								ToastUtil.showToast(getApplicationContext(), st9);
		                    }
		                });
		            }
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
								ToastUtil.showToast(getApplicationContext(), st14 + e.getMessage());
                            }
                        });
                    }
