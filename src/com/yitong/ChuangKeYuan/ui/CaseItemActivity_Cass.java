 ...
 * 创客案例页面
 */
public class CaseItemActivity_Cass extends Activity implements OnClickListener {
    ...
    private void initListView() {
        ...
        body = new FormBody.Builder()
                .add("termid", getIntent().getStringExtra("aid"))
                .add("pagesize", 10000 + "")
                .build();
    ...
    private void initTitlebar() {
        ...
        try {
            mDes.setText(MyApplication.getUtil().mListBeen.get(3).getParent().get(2).getParent_ParentBean().get(getIntent().getIntExtra("index", 0)).getName());
        } catch (Exception e) {
            mDes.setText("");
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_teach_up:
                startActivity(new Intent(CaseItemActivity_Cass.this, UploadActivity.class).putExtra("id", getIntent().getStringExtra("aid")));
                break;
        }
    }
}
