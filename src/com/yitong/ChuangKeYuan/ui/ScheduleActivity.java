...
public class ScheduleActivity extends Activity implements OnClickListener{
    ...
    private void initTitlebar() {
        ...
        try {
            mDes.setText(MyApplication.getUtil().mListBeen.get(3).getParent().get(1).getParent_ParentBean().get(0).getName());
        }catch (Exception e){}
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.iv_teach_up:
                startActivity(new Intent(ScheduleActivity.this, UploadActivity.class).putExtra("id",getIntent().getStringExtra("id")));
                break;
        }
    }
}
