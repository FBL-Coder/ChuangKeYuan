 ...
 * 上传老师
 */
public class UploadTeacherActivity extends Activity implements View.OnClickListener, UploadUtil_Upload.OnUploadProcessListener {
    ...
    private void initView() {
        ...
        scrollview_teacher = (ScrollView) findViewById(R.id.scrollview_teacher);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.upload:
                ...
                final String teachmotto = motto.getText().toString();
                final String profession = baby_name.getText().toString();
                final String politicsStatus = age.getText().toString();
                final String yearWorking = job.getText().toString();
                final String parentdescrible = describle.getText().toString();

                if (name != null && !"".equals(name)) {
                    progressDialog = new ProgressDialog(UploadTeacherActivity.this);
                    ...
                    final Handler mHandler = new Handler() {
                        ...
                        public void handleMessage(Message msg) {
                            ...
                            if (Integer.parseInt(result.getCode()) == 0) {
                                ToastUtil.showToast(UploadTeacherActivity.this, "上传成功");
                                MyApplication.setFLAG(1010);
                                finish();
                            } else {
                                ToastUtil.showToast(UploadTeacherActivity.this, "对不起，上传失败");
                            }
                        ...
                        public void run() {
                            try {
                                FormBody body = new FormBody.Builder()
                                        ...
                                        .add("name", name)
                                        .add("signature", teachmotto)
                                        .add("politicsStatus", politicsStatus)
                                        .add("desc", parentdescrible)
                                        .add("profession", profession)
                                        .add("thumb", photo)
                                        .add("yearWorking", yearWorking).build();
                                String data = HttpDataUtil.getPublicData_POST(DatasUtil.URL_BASE + DatasUtil.URL_Addteacher, body);
                    ...
                    ToastUtil.showToast(UploadTeacherActivity.this, "请完善内容");
                }
                break;
        }
        ...
        if (picPath != null) {
            if (maxSize >= d) {
                if (d >= 1) {
                    ...
                    ToastUtil.showToast(UploadTeacherActivity.this, "对不起，您选择的文件太小，或者路径异常，请重新选择！");
                }
            } else {
                view1.setImageResource(R.drawable.tianjia);
                ToastUtil.showToast(UploadTeacherActivity.this, "对不起，您选择的文件过大！请重新选择..");
            }
        } else {
            ...
            switch (msg.what) {
                ...
                case UPLOAD_FILE_DONE://上传完成后的回调操作
                    if (msg.arg1 == 1) {
                        ...
                        ToastUtil.showToast(UploadTeacherActivity.this, "连接超时,上传失败!");
                    }
                    break;
                default:
                    break;
