...
import com.yitong.ChuangKeYuan.zxing.activity.CaptureActivity;
...
public class AddContactActivity extends BaseActivity{
	...
	private ImageView avatar,saosao;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		saosao = (ImageView) findViewById(R.id.saosao);
		...
		saosao.setOnClickListener(  new View.OnClickListener() {
			...
			public void onClick(View v) {
				//打开扫描界面扫描条形码或二维码
				Intent openCameraIntent = new Intent(AddContactActivity.this, CaptureActivity.class);
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							ToastUtil.showToast(getApplicationContext(), s1);
						}
					});
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							ToastUtil.showToast(getApplicationContext(), s2 + e.getMessage());
						}
					});
				}
			}
