            ...
            public void run() {
                try {
                    String data = HttpDataUtil
                            .getPublicData_POST(DatasUtil.URL_BASE + DatasUtil.URL_getHeadImg,
                                    new FormBody.Builder().build());
                    if (!("".equals(data)) && data != null) {
                        Dtat_Cache.writeFileToSD(data, "AllUser_IMG");
                        Log.i("HEAD", data);
                    }
                } catch (IOException e) {
                    return;
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    HttpDataUtil.getPublicData_POST(DatasUtil.URL_BASE + DatasUtil.URL_logout,
                                            new FormBody.Builder().add("uid", MyApplication.getuserid()).build());
                                    SharedPreferences preferences = MyApplication.getContext().getSharedPreferences("USER", Activity.MODE_PRIVATE);
