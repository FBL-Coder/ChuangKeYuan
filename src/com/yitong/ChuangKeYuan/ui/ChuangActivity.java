 ...
 * 创材页面
 */
public class ChuangActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyApplication.getUtil().mListBeen != null) {
            //初始化标题栏
            initTitlebar();
            //初始化ListView
            initListView();
            ...
            ku_xue_nodata.setVisibility(View.VISIBLE);
        }
    }
    ...
    private void initListView() {
        ...
        list = new AsyncLoaderData_List(this, build, ku_xue_nodata, ku_xue_yichang, mListView, body, "Data_Chuang", count, true, layout);
    ...
    private void initTitlebar() {
        ...
        try {
            mDes.setText(MyApplication.getUtil().mListBeen.get(3).getParent().get(0).getParent_ParentBean().get(2).getName());
        } catch (Exception e) {
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_teach_up:
                startActivity(new Intent(ChuangActivity.this, UploadActivity.class).putExtra("id", getIntent().getStringExtra("id")));
                break;
        }
    }
}
