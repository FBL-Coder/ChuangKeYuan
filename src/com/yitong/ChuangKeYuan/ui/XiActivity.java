 ...
 * 习材页面
 */
public class XiActivity extends Activity implements OnClickListener {
    ...
    private void initListView() {
        ...
        list = new AsyncLoaderData_List(this, build, ku_xue_nodata, ku_xue_yichang, mListView, body, "Data_Xi", count, true, layout);
    ...
    private void initTitlebar() {
        ...
        try {
            mDes.setText(MyApplication.getUtil().mListBeen.get(3).getParent().get(0).getParent_ParentBean().get(1).getName());
        } catch (Exception e) {
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_teach_up:
                startActivity(new Intent(XiActivity.this, UploadActivity.class).putExtra("id", getIntent().getStringExtra("id")));
                break;
        }
    }
}
