...
import com.yitong.ChuangKeYuan.BuildConfig;
import com.yitong.ChuangKeYuan.R;
import com.yitong.ChuangKeYuan.domain.VideoEntity;
import com.yitong.ChuangKeYuan.utils.ToastUtil;
import com.yitong.ChuangKeYuan.video.util.ImageCache;
import com.yitong.ChuangKeYuan.video.util.ImageResizer;
import com.yitong.ChuangKeYuan.video.util.Utils;
import com.yitong.ChuangKeYuan.widget.RecyclingImageView;
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				...
				ToastUtil.showToast(getActivity(), st);
				return;
			}
