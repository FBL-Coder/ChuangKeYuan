...
public class EaseContactAdapter extends ArrayAdapter<EaseUser> implements SectionIndexer {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// 设置头像
//		EaseUserUtils.setUserAvatarAddUserNick(username, holder.nameView);
		// 设置头像
		EaseUserUtils.setUserAvatarAddUserNick(getContext(), username, holder.avatar,holder.nameView);
