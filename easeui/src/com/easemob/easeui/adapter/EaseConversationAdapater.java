...
public class EaseConversationAdapater extends ArrayAdapter<EMConversation> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (conversation.getType() == EMConversationType.GroupChat) {
			...
			holder.name.setText(group != null ? group.getGroupName() : "群聊");
//			EaseUserUtils.setUserAvatarAddUserNick(mContext,username,holder.avatar,null);


		} else if (conversation.getType() == EMConversationType.ChatRoom) {
//			holder.avatar.setImageResource(R.drawable.ease_group_icon);
			EaseUserUtils.setUserAvatarAddUserNick(mContext,username,holder.avatar,holder.name);
