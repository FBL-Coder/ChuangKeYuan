...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct == Direct.SEND){
            EaseUserUtils.setUserAvatarAddUserNick(context, EMChatManager.getInstance().getCurrentUser(),userAvatarView,null);
            //发送方不显示nick
//            UserUtils.setUserNick(EMChatManager.getInstance().getCurrentUser(), usernickView);
        }else{
            EaseUserUtils.setUserAvatarAddUserNick(context, message.getFrom(),userAvatarView,usernickView);
